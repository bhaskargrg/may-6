...
function Marquee() {
  return (
    <div className="w-100 py-20 bg-[#004D43] rounded-tl-3xl rounded-tr-3xl">
      <div className="text border-t-2 border-b-2 border-zinc-200 flex whitespace-nowrap overflow-hidden">
        <motion.h1
          ...
          className='text-[14vw] font-bold leading-none font-["Founder Grotesk X-Condensed"] -mb-[1vw] pt-10'
        >
          OCHI WE ARE
        </motion.h1>
        <motion.h1
